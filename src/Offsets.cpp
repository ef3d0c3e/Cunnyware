#include "Offsets.hpp"
#include "Util/NetVarManager.hpp"
...
void Offsets::GetNetVarOffsets()
{
	...
	offsets.DT_BaseEntity.m_bSpottedByMask = NetVarManager::GetOffset(tables, "DT_BaseEntity", "m_bSpottedByMask");
	...
	offsets.DT_CSPlayer.m_nSurvivalTeam = NetVarManager::GetOffset(tables, "DT_CSPlayer", "m_nSurvivalTeam");
	...
	offsets.DT_BaseAttributableItem.m_bInitialized = NetVarManager::GetOffset(tables, "DT_BaseAttributableItem", "m_bInitialized");
	...
	offsets.DT_BRC4Target.m_bBrokenOpen = NetVarManager::GetOffset(tables, "DT_BRC4Target", "m_bBrokenOpen");
	offsets.DT_BRC4Target.m_flRadius = NetVarManager::GetOffset(tables, "DT_BRC4Target", "m_flRadius");

	offsets.DT_Dronegun.m_vecAttentionTarget = NetVarManager::GetOffset(tables, "DT_Dronegun", "m_vecAttentionTarget");
	offsets.DT_Dronegun.m_vecTargetOffset = NetVarManager::GetOffset(tables, "DT_Dronegun", "m_vecTargetOffset");
	offsets.DT_Dronegun.m_iHealth = NetVarManager::GetOffset(tables, "DT_Dronegun", "m_iHealth");
	offsets.DT_Dronegun.m_bHasTarget = NetVarManager::GetOffset(tables, "DT_Dronegun", "m_bHasTarget");

	offsets.DT_PhysPropLootCrate.m_bRenderInPSPM = NetVarManager::GetOffset(tables, "DT_PhysPropLootCrate", "m_bRenderInPSPM");
	offsets.DT_PhysPropLootCrate.m_bRenderInTablet = NetVarManager::GetOffset(tables, "DT_PhysPropLootCrate", "m_bRenderInTablet");
	offsets.DT_PhysPropLootCrate.m_iHealth = NetVarManager::GetOffset(tables, "DT_PhysPropLootCrate", "m_iHealth");
	offsets.DT_PhysPropLootCrate.m_iMaxHealth = NetVarManager::GetOffset(tables, "DT_PhysPropLootCrate", "m_iMaxHealth");

	offsets.DT_BaseAnimating.m_nSequence = NetVarManager::GetOffset(tables, "DT_BaseAnimating", "m_nSequence");
	offsets.DT_BaseAnimating.m_bClientSideAnimation = NetVarManager::GetOffset(tables, "DT_BaseAnimating", "m_bClientSideAnimation");
	offsets.DT_BaseAnimating.m_nSkin = NetVarManager::GetOffset(tables, "DT_BaseAnimating", "m_nSkin");
	offsets.DT_BaseAnimating.m_nBody = NetVarManager::GetOffset(tables, "DT_BaseAnimating", "m_nBody");
	...
	offsets.DT_BaseAnimating.m_nHitboxSet = NetVarManager::GetOffset(tables, "DT_BaseAnimating", "m_nHitboxSet");
	offsets.DT_BaseAnimating.m_nMuzzleFlashParity = NetVarManager::GetOffset(tables, "DT_BaseAnimating", "m_nMuzzleFlashParity");
	offsets.DT_BaseAnimating.m_hLightingOrigin = NetVarManager::GetOffset(tables, "DT_BaseAnimating", "m_hLightingOrigin");
	offsets.DT_BaseAnimating.m_bClientSideFrameReset = NetVarManager::GetOffset(tables, "DT_BaseAnimating", "m_bClientSideFrameReset");
}
