...
LIBS_PRIVATE       := -lbz2
LIBSSTATIC_CONFIG  := -lfreetype -lz -lbz2 -lpng16 -lm -lz -lm -lz -lharfbuzz -lm -lglib-2.0 -pthread -lpcre -pthread -lfreetype -lpng16 -lm -lz -lm -lz -lbrotlidec -lbrotlicommon -lgraphite2 -lbrotlidec -lbrotlicommon
build_libtool_libs := 
ft_version         := 23.4.17
